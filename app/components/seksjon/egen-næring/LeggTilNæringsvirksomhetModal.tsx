...
export function LeggTilNæringsvirksomhetModal({
  modalRef,
  ...
  const form = useForm({
    ...
    defaultValues: {},
    handleSubmit: (data) => {
      const nyNæringsvirksomhet: Næringsvirksomhet = {
      ...
      setRegistrerteNæringsvirksomheter([...registrerteNæringsvirksomheter, nyNæringsvirksomhet]);
