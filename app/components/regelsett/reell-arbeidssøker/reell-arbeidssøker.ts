...
export const reellArbeidssøkerSpørsmål: Sporsmal[] = [
  {
    ...
    lesMerLabel: "Dette regnes som helsemessige begrensninger",
    lesMerDescription:
  ...
  },
  {
    ...
    lesMerLabel: "Hvis du har uføretrygd",
    lesMerDescription: "Hvis du har uføretrygd må du kunne jobbe minst 11,25 timer per uke.",
