...
export default function Tilleggsopplysninger() {
    ...
    const [harTilleggsopplysninger, setHarTilleggsopplysninger] = useState<boolean | undefined>(undefined);
            ...
            <Form {...form.getFormProps()}>
...

                {
                    harTilleggsopplysninger && (
                        <Textarea label="Skriv inn tilleggsopplysninger her" name="tilleggsopplysninger" maxLength={500}/>
                    )
                }
