        ...
        <Form {...form.getFormProps()}>
          <VStack gap="8">
            ...
            {form.value(hvilkeYtelserMottarDuEllerHarDuSøktPåFraAndreEnnNav) &&
              form
                .value(hvilkeYtelserMottarDuEllerHarDuSøktPåFraAndreEnnNav)
                ?.indexOf("garantiLottForFiskere") !== -1 && (
                <>
                  <Alert variant="info">
            ...
            {form.value(hvilkeYtelserMottarDuEllerHarDuSøktPåFraAndreEnnNav) &&
              form
                .value(hvilkeYtelserMottarDuEllerHarDuSøktPåFraAndreEnnNav)
                ?.indexOf("etterlønnFraArbeidsgiver") !== -1 && (
                <>
                  <Alert variant="info">
            ...
            {form.value(hvilkeYtelserMottarDuEllerHarDuSøktPåFraAndreEnnNav) &&
              form
                .value(hvilkeYtelserMottarDuEllerHarDuSøktPåFraAndreEnnNav)
                ?.indexOf("dagpengerFraAnnetEøsLand") !== -1 && (
                <>
                  <Alert variant="info">
