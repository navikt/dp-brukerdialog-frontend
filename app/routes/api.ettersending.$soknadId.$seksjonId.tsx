...
export async function action({ params, request }: ActionFunctionArgs) {
  ...
  const ettersendinger = formData.get("ettersendinger") as string;

  const url = `${getEnv("DP_SOKNAD_ORKESTRATOR_URL")}/seksjon/${params.soknadId}/${params.seksjonId}/dokumentasjonskrav/ettersending`;
