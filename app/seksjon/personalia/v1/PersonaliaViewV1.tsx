...
export function PersonaliaViewV1() {
  ...
  const formattertKontonummer =
    loaderData.personalia.kontonummer &&
    loaderData.personalia.kontonummer.replace(/(.{4})(.{2})(.{5})/, "$1 $2 $3");
        ...
        <VStack gap="4">
          ...
          <Form {...form.getFormProps()}>
            ...
            <VStack gap="8">
              ...
              {(form.value(folkeregistrertAdresseErNorgeStemmerDet) === "nei" || form.value(landFraPdl) !== "NORGE") && (
                <h2>Bostedsland</h2>
              )}
