import { Gårdsbruk, Næringsvirksomhet } from "~/seksjon/egen-næring/egen-næring.spørsmål";
...
function EgenNæringProvider({
  ...
  const [næringsvirksomhetModalData, setNæringsvirksomhetModalData] = useState<NæringsvirksomhetModalData | undefined>(undefined);
  const [gårdsbrukModalData, setGårdsbrukModalData] = useState<GårdsbrukModalData | undefined>(undefined);
