...
import { konkursVetDuHvorMangeTimerDuJobbetIUka } from "~/seksjon/arbeidsforhold/arbeidsforhold.spørsmål.konkurs";
...
export type Arbeidsforhold = {
  ...
  [oppsagtHvaVarÅrsaken]?: string;
  [sagtOppHvaVarÅrsaken]?: string;
  ...
  [oppsagtVetDuHvorMangeTimerDuJobbetIUka]?: string;
  [sagtOppVetDuHvorMangeTimerDuJobbetIUka]?: string;
  ...
  [oppsagtHvorMangeTimerHarDuJobbetIUka]?: string;
  [sagtOppHvorMangeTimerHarDuJobbetIUka]?: string;
  [avskjedigetHvorMangeTimerHarDuJobbetIUka]?: string;
  [kontraktenErUtgåttHvorMangeTimerHarDuJobbetIUka]?: string;
  [arbeidstidenErRedusertHvorMangeTimerHarDuJobbetIUka]?: string;
  [oppsagtHarDuFåttTilbudOmÅFortsetteHosArbeidsgiverenDinIAnnenStillingEllerEtAnnetStedINorge]?: string;
  ...
  [oppsagtHvaHarDuSvartPåTilbudet]?: string;
  [oppsagtHvaErGrunnenTilAtDuIkkeHarTattImotTilbudet]?: string;
