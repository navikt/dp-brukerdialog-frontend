...
export const sagtOppHvaVarÅrsaken = "sagt-opp-hva-var-årsaken";
export const sagtOppVetDuHvorMangeTimerDuJobbetIUka =
  "sagt-opp-vet-du-hvor-mange-timer-du-jobbet-i-uka";
export const sagtOppHvorMangeTimerHarDuJobbetIUka = "sagt-opp-hvor-mange-timer-har-du-jobbet-i-uka";
...
export const arbeidsforholdModalJegHarSagtOppSelvSpørsmål: KomponentType[] = [
  ...
  {
    id: sagtOppVetDuHvorMangeTimerDuJobbetIUka,
    type: "envalg",
  ...
  {
    id: sagtOppHvorMangeTimerHarDuJobbetIUka,
    type: "kortTekst",
    label: "Skriv inn hvor mange timer du har jobbet per uke før du sa opp",
    visHvis: (svar: ArbeidsforholdModalSvar) =>
      svar[sagtOppVetDuHvorMangeTimerDuJobbetIUka] === "ja",
  },
  {
