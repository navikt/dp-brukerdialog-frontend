...
export const situasjonsbeskrivelseRedusertHelse = "situasjonsbeskrivelse-redusert-helse";
...
export const situasjonsbeskrivelseJegErPermitert = "situasjonsbeskrivelse-jeg-er-permitert";
...
export const situasjonsbeskrivelseAnnenSituasjon = "situasjonsbeskrivelse-annen-situasjon";
export const kanIkkeJobbeBådeHeltidOgDeltidAntallTimer =
  "kan-ikke-jobbe-både-heltid-og-deltid-redusert-helse-antall-timer";
export const kanIkkeJobbeHeltidOgDeltidOgEllerkanIkkeJobbeIHeleNorgeKortOmSituasjonen =
  "kan-ikke-jobbe-heltid-og-deltid-og-ellerkan-ikke-jobbe-i-hele-norge-kort-om-sitasjonen";
...
export type ReellArbeidssøkerSvar = {
  ...
  [kanIkkeJobbeHeltidOgDeltidOgEllerkanIkkeJobbeIHeleNorgeKortOmSituasjonen]?: string;
...
export const reellArbeidssøkerSpørsmål: KomponentType[] = [
  ...
  {
    id: "kanIkkeJobbeHeltidOgDeltidOgEllerkanIkkeJobbeIHeleNorgeSituasjonsbeskrivelseLesMer",
    type: "lesMer",
  ...
  {
    id: kanIkkeJobbeHeltidOgDeltidOgEllerkanIkkeJobbeIHeleNorgeKortOmSituasjonen,
    type: "langTekst",
