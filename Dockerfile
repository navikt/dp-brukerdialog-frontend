...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:26@sha256:5171a504b72b68796b803829b44723308758ed576a2a9629917d4aef655df604 AS runtime
WORKDIR /app
