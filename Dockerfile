...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:24@sha256:cf185c04b6dd4955ca4b362a46b94dcdf8a4f794378004ee329ac39c4a7ed3a6 AS runtime
WORKDIR /app
