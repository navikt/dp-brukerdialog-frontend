...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:24@sha256:372cc995e8a23bbbca01efb950742bab6a9b6b1d76d870e79c3a619353bba511 AS runtime
WORKDIR /app
